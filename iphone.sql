...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 13 août 2024 à 21:53
...
(5, 'Camara', 'Madou', 'madou@gmail.com', '345646', 2, '$2y$10$VOahAsaZBsPBgN.wJRJpt.76F/DxoJ9qrO6DlZpEeY7gtE3skTxlm'),
(6, 'Toure', 'Madous', 'madou1@gmail.com', '5146592045', 2, '$2y$10$mo2Es.VxDbpAcjVaW9pHpO5bkq1i.apRaNPEfbhbd5RK.QlhM17xq'),
(7, 'Admin', 'fafa', 'superAdmin@iphone.ca', '23456789', 2, '$2y$10$hgnaE/wNW05xO.hSwL.gRO7JlQ2mAUcdtlhcyt.om.F102hJ8aBJS'),
(8, 'admin', 'admin', 'superAdmin@iphone.ca', '1234', 2, '$2y$10$FecxhoVLyDjcJbPgmjo2dO46BO41yWmhtec26c/gjN6YL5s9WIMry'),
(9, 'Admin', 'Admin', 'superAdmin@iphone.ca', '23456789', 2, '$2y$10$4.5YLasdj0iGUyhov6mNw.oZv55JQIPeujrit.M9zv9NhVpBkrKoa'),
(10, 'tata', 'conde', 'tata@gmail.com', '5146592045', 2, '$2y$10$E6m9d8xESK.LwhaQC7o7e.YBCyt6B/DbsS0AcRHIHETYh7qHWIJAW'),
(11, 'Lisa', 'Mel', 'lisa@gmail.com', '22222222', 2, '$2y$10$BICYnDl2uU40JuWFmmQmyeN/lu8qqJ/MUhxhQF27sGmz0hUlUmst.'),
(12, 'mara', 'raar', 'mara@gmail.com', '1235', 1, '$2y$10$OzpQ3eKawVNPp.GWRlLn/ONy6t6OoWYWa1c7RdZdEKMA2P.zRtaNi'),
(13, 'quart', 'mara', 'quart@gmail.com', '123', 2, '$2y$10$2lZYpQlGFd/d5F3EtcG0duGBuNNeWua42aESCpqcAZaqXxFrCLcWq');
...
--
ALTER TABLE `iphone`
  MODIFY `id_iphone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
